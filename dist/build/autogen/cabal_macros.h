...
/* package my-smtp-0.1.0.0 */
#define VERSION_my_smtp "0.1.0.0"
#define MIN_VERSION_my_smtp(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "my-smtp-0.1.0.0"

#define CURRENT_PACKAGE_KEY "my-smtp-0.1.0.0"
